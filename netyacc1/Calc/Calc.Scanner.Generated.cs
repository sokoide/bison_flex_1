...
//
//  GPLEX Version:  1.2.2
//  DateTime: 11/9/2023 8:01:33PM
//  GPLEX input file <Calc/Calc.Language.analyzer.lex - 11/9/2023 7:59:22PM>
...
#if BABEL
     internal sealed partial class CalcScanner : ScanBase, IColorScan
    {
...
#else  // BABEL
     internal sealed partial class CalcScanner : ScanBase
    {
        private ScanBuff buffer;
        int currentScOrd;  // start condition ordinal
#endif // BABEL
...
#if !NOFILES
     internal CalcScanner(Stream file) {
            SetSource(file); // no unicode option
        }   
#endif // !NOFILES

     internal CalcScanner() { }
...
/* skip */
            break;
        case 2: // Recognized '{Symbol}',	Shortest string "("
return(yytext[0]);
            break;
